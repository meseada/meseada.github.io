              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    if($kategoricek['kategori_resim_durum'] == 'true'){
                      ?> 
                      ...
                      <img width="100" height="100" src="<?php echo 'img/'.$kategoricek['kategori_resim_yukleme']; ?>">
                     ...
                     ?></td>
                    <td><?php echo $kategoricek['kategori_isim']; ?>
                    </td>
                    <td><a href="kategori-duzenle.php?kategori_id=<?php echo $kategoricek['kategori_id']; ?>"><button class="btn btn-primary">Düzenle</button></a></td>

                    <td><a href="config/islem.php?kategori_id=<?php echo $kategoricek['kategori_id'] ?>&kategorisil=ok"><button class="btn btn-danger">Sil</button></a></td>
